...
class Carbon extends DateTime
{
    ...
    {
        $dt = $dt ?: static::now($this->getTargetedTimezone());
    ...
    {
        return $this->toDateString() === static::yesterday($this->getTargetedTimezone())->toDateString();
    }
    ...
    {
        return $this->toDateString() === static::now($this->getTargetedTimezone())->toDateString();
    }
    ...
    {
        return $this->toDateString() === static::tomorrow($this->getTargetedTimezone())->toDateString();
    }
    ...
    {
        return $this->gt(static::now($this->getTargetedTimezone()));
    }
    ...
    {
        return $this->lt(static::now($this->getTargetedTimezone()));
    }
    ...
    {
        $start = $this;
        $end = $dt ?: static::now($this->getTargetedTimezone());
        $inverse = false;
    ...
    public function diffForHumans(Carbon $other = null, $absolute = false)
    {
        ...
        if ($isNow) {
            $other = static::now($this->getTargetedTimezone());
        }
     ...
     * @return string
     */
    private function getTargetedTimezone()
    {
        static $userTimezone;

        if (null === $userTimezone) {
            $userTimezone = \Craft\craft()->getTimeZone();
        }
